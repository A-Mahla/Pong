    ...
    constructor() {
        super({
            ...
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([(request) => {
                    const data = request === null || request === void 0 ? void 0 : request.cookies[`${constants_1.jwtConstants.refresh_jwt_name}`];
                    if (!data) {
                        return null;
                    }
                    return data;
                }]),
            secretOrKey: constants_1.jwtConstants.refresh_jwt_secret,
            passReqToCallback: true,
            ignoreExpiration: false
        });
    }
    validate(request, payload) {
        const refreshToken = request === null || request === void 0 ? void 0 : request.cookies[`${constants_1.jwtConstants.refresh_jwt_name}`];
